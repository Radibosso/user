...
/*Future<void> payMoney() async {
  double totalFare = 0.0;
  for (int i = 0; i < etaDetails.length; i++) {
    if (etaDetails[i]['has_discount'] != true) {
      totalFare += etaDetails[i]['total'];
    } else {
      totalFare += etaDetails[i]['discounted_totel'];
    }
  }

  // Round total fare to nearest whole number and remove decimals
  ...
  showModalBottomSheet(
    ...
    builder: (BuildContext context) {
      return SingleChildScrollView(
        ...
        child: Column(
          children: paymentGateways.map((i, value) {
            return MapEntry(
              i,
              InkWell(
                onTap: () async {
                ...
                child: Container(
                  // Access MediaQuery.of(context) only inside the build method
                      ...
                      WidgetsBinding.instance.addPostFrameCallback((_) {
                        if (isCardPayment == true) {
                          Navigator.pushAndRemoveUntil(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const Invoice1()),
                              (route) => false);
                        } else {
                          Navigator.pushAndRemoveUntil(
                              context,
                                                      ...
                                                      children: [
                                                                  ...
                                                                  if (((rentalOption.isEmpty && (etaDetails[choosenVehicle]['user_wallet_balance'] >= etaDetails[choosenVehicle]['total'] && etaDetails[choosenVehicle]['has_discount'] == false) || (rentalOption.isEmpty && etaDetails[choosenVehicle]['has_discount'] == true && etaDetails[choosenVehicle]['user_wallet_balance'] >= etaDetails[choosenVehicle]['discounted_totel'])) ||
                                                                    ...
                                                                    if (choosenVehicle !=
                                                                      ...
                                                                      setState(
                                                                          () {
                                                                        choosenDateTime =
                                                                            DateTime.now().add(Duration(minutes: int.parse(userDetails['user_can_make_a_ride_after_x_miniutes'])));
                                                                ...
                                                                child: (!confirmRideLater)
                                                                    ? Container(
                                                                        ...
                                                                        child: (confirmRideLater ==
                                                                                false)
                                                                            ? Image.asset(
                                                                                'assets/images/ridesearching.gif',
                                                                                color: textColor,
                                                                              )
                                                                            : MyText(
                                                        ...
                                                        Button(
                                                            ...
                                                            onTap: () async {
                                                              if (choosenVehicle !=
                                                                  null) {
                                                                isCardPayment = etaDetails[choosenVehicle]
                                                                            [
                                                                            'payment_type']
                                                                        .toString()
                                                                        .split(
                                                                    ...
                                                                    'card';
                                                                if (isCardPayment) {
                                                                  if (/*userRequestData.isNotEmpty &&*/ etaDetails
                                                                      .isNotEmpty) {
                                                                    //var val = true; // Set val to true directly or any other desired value
                                                                    double
                                                                        totalFare =
                                                                        0.0;
                                                                    for (int i =
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return SingleChildScrollView(
                                                                          ...
                                                                          child:
                                                                              Column(
                                                                            children:
                                                                                paymentGateways.values.map((value) {
                                                                              return InkWell(
                                                                                onTap: () async {
                                                            ...
                                                            userRequestData['requestBill']
                                                                ...
                                                                .toStringAsFixed(
                                                                    2));*/
                                                                                  //addMoney = double.parse(money.toStringAsFixed(2));
                                                                                  var val = await Navigator.push(
                                                                                    context,
                                                                                    MaterialPageRoute(builder: (context) => PaymentGateways(from: '1', url: value['url'])),
                                                                                  );
                                                                                  ...
                                                                                  if (val != null && val) {
                                                                                    ...
                                                                                    ismulitipleride = true;
                                                                                    var userDetails = await getUserDetails(id: userRequestData['id']);
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  decoration: BoxDecoration(image: DecorationImage(image: NetworkImage(value['image']))),
                                                                                ),
                                                                              );
                                                                            }).toList(),
                                                                          ),
                                                                  ...
                                                                  if (((rentalOption.isEmpty && (etaDetails[choosenVehicle]['user_wallet_balance'] >= etaDetails[choosenVehicle]['total'] && etaDetails[choosenVehicle]['has_discount'] == false) || (rentalOption.isEmpty && etaDetails[choosenVehicle]['has_discount'] == true && etaDetails[choosenVehicle]['user_wallet_balance'] >= etaDetails[choosenVehicle]['discounted_totel'])) ||
                                                                      ...
                                                                      ((rentalOption.isNotEmpty && etaDetails[0]['user_wallet_balance'] >= rentalOption[choosenVehicle]['fare_amount'] && rentalOption[choosenVehicle]['has_discount'] == false) ||
                                                                          (rentalOption.isNotEmpty &&
                                                                              rentalOption[choosenVehicle]['has_discount'] == true &&
                                                                              rentalOption[choosenVehicle]['user_wallet_balance'] >= rentalOption[choosenVehicle]['discounted_totel']) ||
                                                                          rentalOption.isNotEmpty && rentalOption[choosenVehicle]['payment_type'].toString().split(',').toList()[payingVia] != 'wallet')) {
                                                                    setState(
                                                                        () {
                                                                      _isLoading =
                                                                          ...
                                                                          children: [
                                                                            MyText(
                                                                              text: (userRequestData['accepted_at'] != null && userRequestData['arrived_at'] == null && _dist != null)
                                                                                  ? languages[choosenLanguage]['text_arriving_in']
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Row(
                                                                              children: [
                                                                                MyText(
                                                                                  text: userRequestData['car_make_name'].toString(),
                                                                                  size: media.width * fourteen,
                                                                                  fontweight: FontWeight.w600,
                                                                                ),
                                                                                Container(
                                                                                ...
                                                                                MyText(
                                                                                  text: userRequestData['car_model_name'].toString(),
                                                                                  size: media.width * fourteen,
                                                                                  fontweight: FontWeight.w600,
                                                                                )
                                                                              ],
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Column(
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      MyText(
                                                                                        text: '${userRequestData['requested_currency_symbol']}${userRequestData['request_eta_amount']}',
                                                                                        size: media.width * sixteen,
                                                                                        fontweight: FontWeight.w600,
                                                                                      )
                                                                                    ],
                                                            ...
                                                            if (addressList
                                                              ...
                                                              for (var i = 1;
                                                                ...
                                                                dropStopList.add(DropStops(
                                                                    order: i
                                                                        .toString(),
                                                                    latitude: addressList[
                                                                            i]
                                                                        .latlng
                                                                        .latitude,
                                                                    longitude: addressList[
                                                                            i]
                                                                        .latlng
                                                                        .longitude,
                                                                    address: addressList[
