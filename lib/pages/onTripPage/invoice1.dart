...
class Invoice1 extends StatefulWidget {
  const Invoice1({super.key});

  @override
  State<Invoice1> createState() => _InvoiceState();
}

class _InvoiceState extends State<Invoice1> {
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Text(
                                                                                          (userRequestData['payment_type'].toString().split(',').toList()[i] == 'cash')
                                                                                              ? languages[choosenLanguage]['text_paycash1']
                                                                                              : (userRequestData['payment_type'].toString().split(',').toList()[i] == 'wallet')
                                                                  ...
                                                                  showModalBottomSheet(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Container(
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              color: page,
                                                                              borderRadius: BorderRadius.only(topLeft: Radius.circular(media.width * 0.05), topRight: Radius.circular(media.width * 0.05))),
                                                                          child:
                                                                                        ...
                                                                                        (paymentGateways[i]['enabled'] == true)
                                                                                            ? InkWell(
                                                                                                onTap: () async {
                                                                                                  ...
                                                                                                  var val = await Navigator.push(context, MaterialPageRoute(builder: (context) => PaymentGateways(url: paymentGateways[i]['url'])));
                                                                                                  if (val != null) {
                                                                                                    if (val) {
                                                                                                      setState(() {
                                                                                                        _isLoading = true;
