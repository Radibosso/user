                                                                      ...
                                                                      options: fm.MapOptions(
                                                                          onMapEvent: (v) async {
                                                                            ...
                                                                            if (v.source ==
                                                                             ...
                                                                             // printWrapped(myMarkers.toString());
                                                                              _centerLocation = LatLng(v.camera.center.latitude, v.camera.center.longitude);
                                                                              setState(() {});
                                                                              ...
                                                                              .map((k, value) => MapEntry(
                                                                                  ...
                                                                                  fm.Marker(
                                                                                      ...
                                                                                      child: RotationTransition(
                                                                                          ...
                                                                                          child: Image.asset(
                                                                                            (myMarkers[k].markerId.toString().replaceAll('MarkerId(', '').replaceAll(')', '').split('#')[2].toString() == 'taxi') ? 'assets/images/top-taxi.png' : 'assets/images/bike.png',
                                                                                          )))))
                                                                              .values
                                                                              .toList(),
                                                                        ),
                                                                ...
                                                                (_bottom == 1)
                                                                    ? Container(
                                                                        ...
                                                                        decoration:
                                                                            BoxDecoration(
                                                                          borderRadius:
                                                                              BorderRadius.circular(media.width * 0.09),
                                                                          color:
                                                                              page,
                                                                        ),
                                                                        child:
                                                                                    ...
                                                                                    child: Row(
                                                                                      children: [
                                                                                        Container(
                                                                                          ...
                                                                                          width: media.width * 0.05,
                                                                                          alignment: Alignment.center,
                                                                                          decoration: BoxDecoration(shape: BoxShape.circle, color: (isDarkTheme == true) ? Colors.white : const Color(0xff1DA1F2).withOpacity(0.3)),
                                                                                          child: Icon(
                                                                                            Icons.place,
                                                                                  ...
                                                                                  child: Row(
                                                                                    children: [
                                                                                      Container(
                                                                                        ...
                                                                                        decoration: BoxDecoration(color: loop.withOpacity(0.1), borderRadius: BorderRadius.circular(media.width * 0.05)),
                                                                                        child: RotatedBox(
                                                                                          quarterTurns: 3,
                                                                                          child: Icon(
                                                                                            Icons.route_sharp,
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Stack(
                                                                            children: [
                                                                              Container(
                                                                                padding: EdgeInsets.all(media.width * 0.01),
                                                                                decoration: BoxDecoration(color: hintColor.withOpacity(0.1), borderRadius: BorderRadius.circular(media.width * 0.04), border: Border.all(color: loop)),
                                                                                height: media.width * 0.1,
                                                                                width: media.width * 0.9,
                                                                                child: Row(
                                                                                  children: [
                                                                                    Container(
                                                                                      ...
                                                                                      alignment: Alignment.center,
                                                                                      decoration: BoxDecoration(shape: BoxShape.circle, color: const Color(0xff1DA1F2).withOpacity(0.3)),
                                                                                      child: Container(
                                                                                        height: media.width * 0.06,
                                                                                        width: media.width * 0.06,
                                                                                        alignment: Alignment.center,
                                                                                                                    ...
                                                                                                                    setState(() {
                                                                                                                      if (addressList.where((element) => element.type == 'pickup').isEmpty) {
                                                                                                                        addressList.add(AddressList(
                                                                                                                          ...
                                                                                                                          type: 'pickup',
                                                                                                                          pickup: true,
                                                                                                                          address: (addAutoFill[i]['description'] != null) ? addAutoFill[i]['description'] : addAutoFill[i]['display_name'],
                                                                                                                          latlng: (addAutoFill[i]['description'] != null) ? val : LatLng(double.parse(addAutoFill[i]['lat'].toString()), double.parse(addAutoFill[i]['lon'].toString())),
                                                                                                                        ));
                                                                                                                      } else {
