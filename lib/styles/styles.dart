...
Color buttonColor = const Color(0xFF18AAE8);
Color theme = const Color(0xFF18AAE8);
...
Color loaderColor = const Color(0xff203b6b);
Color notUploadedColor = const Color(0xFF18AAE8);
Color verifyPendingBck = const Color(0xffFEF2F2);
Color verifyPending = const Color(0xFF18AAE8);
...
Color starColor = const Color(0xFF18AAE8);
Color loop = const Color(0xff90D6F4);
